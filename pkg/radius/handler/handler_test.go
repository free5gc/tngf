...
func TestHandleRadiusAccessRequestRejectsMissingEAPInInitialContextSetup(t *testing.T) {
	...
	session.State = handler.InitialContextSetup
...
func TestHandleRadiusAccessRequestRejectsShortEAPResponseInEAP5GNAS(t *testing.T) {
	...
	// EAP Response with length=4 has no type data and should be treated as malformed.
